...
build/learner_demo/lesson.s: language_learning/tools/ui.py language_learning/ui.json language_learning/ui_sources.json language_learning/map_names.json include/constants/region_map_sections.h language_learning/tools/opening.py language_learning/opening.json language_learning/tools/build_demo.py language_learning/tools/validate.py language_learning/integration/lesson_script.inc language_learning/integration/dialogue_catalog.json language_learning/fonts/cyrillic.json $(wildcard language_learning/language_packs/*/pack.json) charmap.txt
