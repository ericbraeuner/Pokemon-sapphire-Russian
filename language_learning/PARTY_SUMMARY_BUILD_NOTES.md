...
- Russian party/action screens and Russian and German summary pages were inspected
  ...
  held-item text, stats, and encounter location all changed with the saved language.
...
- Replace the English labels baked into the summary background artwork, including
  PROFILE, ABILITY, ITEM, RIBBON, STATS, MOVES, and DESCRIPTION.
