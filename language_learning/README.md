...
separate from the normal ROM build. An optional playable build translates six house scenes in Russian and German,
...
`opening.json` currently holds the six additional source-symbol mappings,
...
Language and CEFR selection use reserved persistent variables 0x40F0/0x40F1.
