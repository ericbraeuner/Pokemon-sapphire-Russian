...
static const u8 *LearnerDexSpeciesName(u16 dexNum, const u8 *fallback)
{
    ...
    case NATIONAL_DEX_LOTAD: return LEARNER_UI(Learner_GetLanguage(), LotadName);
    case NATIONAL_DEX_SEEDOT: return LEARNER_UI(Learner_GetLanguage(), SeedotName);
    case NATIONAL_DEX_RALTS: return LEARNER_UI(Learner_GetLanguage(), RaltsName);
    case NATIONAL_DEX_SURSKIT: return LEARNER_UI(Learner_GetLanguage(), SurskitName);
    case NATIONAL_DEX_TAILLOW: return LEARNER_UI(Learner_GetLanguage(), TaillowName);
    case NATIONAL_DEX_WINGULL: return LEARNER_UI(Learner_GetLanguage(), WingullName);
    case NATIONAL_DEX_SHROOMISH: return LEARNER_UI(Learner_GetLanguage(), ShroomishName);
    case NATIONAL_DEX_WHISMUR: return LEARNER_UI(Learner_GetLanguage(), WhismurName);
    case NATIONAL_DEX_SLAKOTH: return LEARNER_UI(Learner_GetLanguage(), SlakothName);
    case NATIONAL_DEX_NINCADA: return LEARNER_UI(Learner_GetLanguage(), NincadaName);
    case NATIONAL_DEX_SKITTY: return LEARNER_UI(Learner_GetLanguage(), SkittyName);
    case NATIONAL_DEX_SABLEYE: return LEARNER_UI(Learner_GetLanguage(), SableyeName);
    case NATIONAL_DEX_ZANGOOSE: return LEARNER_UI(Learner_GetLanguage(), ZangooseName);
    case NATIONAL_DEX_SEVIPER: return LEARNER_UI(Learner_GetLanguage(), SeviperName);
    case NATIONAL_DEX_BARBOACH: return LEARNER_UI(Learner_GetLanguage(), BarboachName);
    case NATIONAL_DEX_CORPHISH: return LEARNER_UI(Learner_GetLanguage(), CorphishName);
    case NATIONAL_DEX_BALTOY: return LEARNER_UI(Learner_GetLanguage(), BaltoyName);
    case NATIONAL_DEX_LILEEP: return LEARNER_UI(Learner_GetLanguage(), LileepName);
    case NATIONAL_DEX_ANORITH: return LEARNER_UI(Learner_GetLanguage(), AnorithName);
    case NATIONAL_DEX_FEEBAS: return LEARNER_UI(Learner_GetLanguage(), FeebasName);
    case NATIONAL_DEX_CASTFORM: return LEARNER_UI(Learner_GetLanguage(), CastformName);
    case NATIONAL_DEX_KECLEON: return LEARNER_UI(Learner_GetLanguage(), KecleonName);
    case NATIONAL_DEX_SHUPPET: return LEARNER_UI(Learner_GetLanguage(), ShuppetName);
    case NATIONAL_DEX_DUSKULL: return LEARNER_UI(Learner_GetLanguage(), DuskullName);
    case NATIONAL_DEX_TROPIUS: return LEARNER_UI(Learner_GetLanguage(), TropiusName);
    case NATIONAL_DEX_CHIMECHO: return LEARNER_UI(Learner_GetLanguage(), ChimechoName);
    case NATIONAL_DEX_ABSOL: return LEARNER_UI(Learner_GetLanguage(), AbsolName);
    case NATIONAL_DEX_WYNAUT: return LEARNER_UI(Learner_GetLanguage(), WynautName);
    case NATIONAL_DEX_SNORUNT: return LEARNER_UI(Learner_GetLanguage(), SnoruntName);
    case NATIONAL_DEX_SPHEAL: return LEARNER_UI(Learner_GetLanguage(), SphealName);
    case NATIONAL_DEX_CLAMPERL: return LEARNER_UI(Learner_GetLanguage(), ClamperlName);
    case NATIONAL_DEX_BAGON: return LEARNER_UI(Learner_GetLanguage(), BagonName);
    case NATIONAL_DEX_MAKUHITA: return LEARNER_UI(Learner_GetLanguage(), MakuhitaName);
    case NATIONAL_DEX_ARON: return LEARNER_UI(Learner_GetLanguage(), AronName);
    case NATIONAL_DEX_MEDITITE: return LEARNER_UI(Learner_GetLanguage(), MedititeName);
    case NATIONAL_DEX_ELECTRIKE: return LEARNER_UI(Learner_GetLanguage(), ElectrikeName);
    case NATIONAL_DEX_PLUSLE: return LEARNER_UI(Learner_GetLanguage(), PlusleName);
    case NATIONAL_DEX_MINUN: return LEARNER_UI(Learner_GetLanguage(), MinunName);
    case NATIONAL_DEX_ROSELIA: return LEARNER_UI(Learner_GetLanguage(), RoseliaName);
    case NATIONAL_DEX_GULPIN: return LEARNER_UI(Learner_GetLanguage(), GulpinName);
    case NATIONAL_DEX_NUMEL: return LEARNER_UI(Learner_GetLanguage(), NumelName);
    case NATIONAL_DEX_SPOINK: return LEARNER_UI(Learner_GetLanguage(), SpoinkName);
    case NATIONAL_DEX_TRAPINCH: return LEARNER_UI(Learner_GetLanguage(), TrapinchName);
    case NATIONAL_DEX_SWABLU: return LEARNER_UI(Learner_GetLanguage(), SwabluName);
    case NATIONAL_DEX_GROVYLE: return LEARNER_UI(Learner_GetLanguage(), GrovyleName);
    case NATIONAL_DEX_SCEPTILE: return LEARNER_UI(Learner_GetLanguage(), SceptileName);
    case NATIONAL_DEX_COMBUSKEN: return LEARNER_UI(Learner_GetLanguage(), CombuskenName);
    case NATIONAL_DEX_BLAZIKEN: return LEARNER_UI(Learner_GetLanguage(), BlazikenName);
    case NATIONAL_DEX_MARSHTOMP: return LEARNER_UI(Learner_GetLanguage(), MarshtompName);
    case NATIONAL_DEX_SWAMPERT: return LEARNER_UI(Learner_GetLanguage(), SwampertName);
    case NATIONAL_DEX_MIGHTYENA: return LEARNER_UI(Learner_GetLanguage(), MightyenaName);
    case NATIONAL_DEX_LINOONE: return LEARNER_UI(Learner_GetLanguage(), LinooneName);
    case NATIONAL_DEX_SILCOON: return LEARNER_UI(Learner_GetLanguage(), SilcoonName);
    case NATIONAL_DEX_BEAUTIFLY: return LEARNER_UI(Learner_GetLanguage(), BeautiflyName);
    case NATIONAL_DEX_CASCOON: return LEARNER_UI(Learner_GetLanguage(), CascoonName);
    case NATIONAL_DEX_DUSTOX: return LEARNER_UI(Learner_GetLanguage(), DustoxName);
    case NATIONAL_DEX_LOMBRE: return LEARNER_UI(Learner_GetLanguage(), LombreName);
    case NATIONAL_DEX_LUDICOLO: return LEARNER_UI(Learner_GetLanguage(), LudicoloName);
    case NATIONAL_DEX_NUZLEAF: return LEARNER_UI(Learner_GetLanguage(), NuzleafName);
    case NATIONAL_DEX_SHIFTRY: return LEARNER_UI(Learner_GetLanguage(), ShiftryName);
    case NATIONAL_DEX_KIRLIA: return LEARNER_UI(Learner_GetLanguage(), KirliaName);
    case NATIONAL_DEX_GARDEVOIR: return LEARNER_UI(Learner_GetLanguage(), GardevoirName);
    case NATIONAL_DEX_MASQUERAIN: return LEARNER_UI(Learner_GetLanguage(), MasquerainName);
    case NATIONAL_DEX_SWELLOW: return LEARNER_UI(Learner_GetLanguage(), SwellowName);
    case NATIONAL_DEX_PELIPPER: return LEARNER_UI(Learner_GetLanguage(), PelipperName);
    case NATIONAL_DEX_BRELOOM: return LEARNER_UI(Learner_GetLanguage(), BreloomName);
    case NATIONAL_DEX_LOUDRED: return LEARNER_UI(Learner_GetLanguage(), LoudredName);
    case NATIONAL_DEX_EXPLOUD: return LEARNER_UI(Learner_GetLanguage(), ExploudName);
    case NATIONAL_DEX_HARIYAMA: return LEARNER_UI(Learner_GetLanguage(), HariyamaName);
    case NATIONAL_DEX_LAIRON: return LEARNER_UI(Learner_GetLanguage(), LaironName);
    case NATIONAL_DEX_AGGRON: return LEARNER_UI(Learner_GetLanguage(), AggronName);
    case NATIONAL_DEX_MEDICHAM: return LEARNER_UI(Learner_GetLanguage(), MedichamName);
    case NATIONAL_DEX_MANECTRIC: return LEARNER_UI(Learner_GetLanguage(), ManectricName);
    case NATIONAL_DEX_SWALOT: return LEARNER_UI(Learner_GetLanguage(), SwalotName);
    case NATIONAL_DEX_CAMERUPT: return LEARNER_UI(Learner_GetLanguage(), CameruptName);
    case NATIONAL_DEX_GRUMPIG: return LEARNER_UI(Learner_GetLanguage(), GrumpigName);
    case NATIONAL_DEX_VIBRAVA: return LEARNER_UI(Learner_GetLanguage(), VibravaName);
    case NATIONAL_DEX_FLYGON: return LEARNER_UI(Learner_GetLanguage(), FlygonName);
    case NATIONAL_DEX_ALTARIA: return LEARNER_UI(Learner_GetLanguage(), AltariaName);
    case NATIONAL_DEX_GLALIE: return LEARNER_UI(Learner_GetLanguage(), GlalieName);
    case NATIONAL_DEX_WALREIN: return LEARNER_UI(Learner_GetLanguage(), WalreinName);
    case NATIONAL_DEX_HUNTAIL: return LEARNER_UI(Learner_GetLanguage(), HuntailName);
    case NATIONAL_DEX_GOREBYSS: return LEARNER_UI(Learner_GetLanguage(), GorebyssName);
    case NATIONAL_DEX_SHELGON: return LEARNER_UI(Learner_GetLanguage(), ShelgonName);
    case NATIONAL_DEX_SALAMENCE: return LEARNER_UI(Learner_GetLanguage(), SalamenceName);
    case NATIONAL_DEX_CRADILY: return LEARNER_UI(Learner_GetLanguage(), CradilyName);
    case NATIONAL_DEX_ARMALDO: return LEARNER_UI(Learner_GetLanguage(), ArmaldoName);
    case NATIONAL_DEX_BANETTE: return LEARNER_UI(Learner_GetLanguage(), BanetteName);
    case NATIONAL_DEX_DUSCLOPS: return LEARNER_UI(Learner_GetLanguage(), DusclopsName);
    case NATIONAL_DEX_METANG: return LEARNER_UI(Learner_GetLanguage(), MetangName);
    case NATIONAL_DEX_METAGROSS: return LEARNER_UI(Learner_GetLanguage(), MetagrossName);
    case NATIONAL_DEX_REGIROCK: return LEARNER_UI(Learner_GetLanguage(), RegirockName);
    case NATIONAL_DEX_REGICE: return LEARNER_UI(Learner_GetLanguage(), RegiceName);
    case NATIONAL_DEX_REGISTEEL: return LEARNER_UI(Learner_GetLanguage(), RegisteelName);
    case NATIONAL_DEX_LATIAS: return LEARNER_UI(Learner_GetLanguage(), LatiasName);
    ...
    case NATIONAL_DEX_VIGOROTH: return LEARNER_UI(Learner_GetLanguage(), VigorothName);
    case NATIONAL_DEX_SLAKING: return LEARNER_UI(Learner_GetLanguage(), SlakingName);
    case NATIONAL_DEX_ABRA: return LEARNER_UI(Learner_GetLanguage(), AbraName);
    case NATIONAL_DEX_KADABRA: return LEARNER_UI(Learner_GetLanguage(), KadabraName);
    case NATIONAL_DEX_ALAKAZAM: return LEARNER_UI(Learner_GetLanguage(), AlakazamName);
    case NATIONAL_DEX_NINJASK: return LEARNER_UI(Learner_GetLanguage(), NinjaskName);
    case NATIONAL_DEX_SHEDINJA: return LEARNER_UI(Learner_GetLanguage(), ShedinjaName);
    case NATIONAL_DEX_GOLDEEN: return LEARNER_UI(Learner_GetLanguage(), GoldeenName);
    case NATIONAL_DEX_SEAKING: return LEARNER_UI(Learner_GetLanguage(), SeakingName);
    case NATIONAL_DEX_MAGIKARP: return LEARNER_UI(Learner_GetLanguage(), MagikarpName);
    case NATIONAL_DEX_GYARADOS: return LEARNER_UI(Learner_GetLanguage(), GyaradosName);
    case NATIONAL_DEX_AZURILL: return LEARNER_UI(Learner_GetLanguage(), AzurillName);
    case NATIONAL_DEX_MARILL: return LEARNER_UI(Learner_GetLanguage(), MarillName);
    case NATIONAL_DEX_AZUMARILL: return LEARNER_UI(Learner_GetLanguage(), AzumarillName);
    case NATIONAL_DEX_GEODUDE: return LEARNER_UI(Learner_GetLanguage(), GeodudeName);
    case NATIONAL_DEX_GRAVELER: return LEARNER_UI(Learner_GetLanguage(), GravelerName);
    case NATIONAL_DEX_GOLEM: return LEARNER_UI(Learner_GetLanguage(), GolemName);
    ...
    case NATIONAL_DEX_STARMIE: return LEARNER_UI(Learner_GetLanguage(), StarmieName);
    case NATIONAL_DEX_VULPIX: return LEARNER_UI(Learner_GetLanguage(), VulpixName);
    case NATIONAL_DEX_NINETALES: return LEARNER_UI(Learner_GetLanguage(), NinetalesName);
    case NATIONAL_DEX_PICHU: return LEARNER_UI(Learner_GetLanguage(), PichuName);
    case NATIONAL_DEX_PIKACHU: return LEARNER_UI(Learner_GetLanguage(), PikachuName);
    case NATIONAL_DEX_RAICHU: return LEARNER_UI(Learner_GetLanguage(), RaichuName);
    case NATIONAL_DEX_PSYDUCK: return LEARNER_UI(Learner_GetLanguage(), PsyduckName);
    case NATIONAL_DEX_GOLDUCK: return LEARNER_UI(Learner_GetLanguage(), GolduckName);
    case NATIONAL_DEX_WOBBUFFET: return LEARNER_UI(Learner_GetLanguage(), WobbuffetName);
    case NATIONAL_DEX_NATU: return LEARNER_UI(Learner_GetLanguage(), NatuName);
    case NATIONAL_DEX_XATU: return LEARNER_UI(Learner_GetLanguage(), XatuName);
    case NATIONAL_DEX_GIRAFARIG: return LEARNER_UI(Learner_GetLanguage(), GirafarigName);
    case NATIONAL_DEX_PHANPY: return LEARNER_UI(Learner_GetLanguage(), PhanpyName);
    case NATIONAL_DEX_DONPHAN: return LEARNER_UI(Learner_GetLanguage(), DonphanName);
    case NATIONAL_DEX_PINSIR: return LEARNER_UI(Learner_GetLanguage(), PinsirName);
    case NATIONAL_DEX_HERACROSS: return LEARNER_UI(Learner_GetLanguage(), HeracrossName);
    case NATIONAL_DEX_RHYHORN: return LEARNER_UI(Learner_GetLanguage(), RhyhornName);
    case NATIONAL_DEX_RHYDON: return LEARNER_UI(Learner_GetLanguage(), RhydonName);
    case NATIONAL_DEX_SEALEO: return LEARNER_UI(Learner_GetLanguage(), SealeoName);
    case NATIONAL_DEX_RELICANTH: return LEARNER_UI(Learner_GetLanguage(), RelicanthName);
    case NATIONAL_DEX_CORSOLA: return LEARNER_UI(Learner_GetLanguage(), CorsolaName);
    case NATIONAL_DEX_CHINCHOU: return LEARNER_UI(Learner_GetLanguage(), ChinchouName);
    case NATIONAL_DEX_LANTURN: return LEARNER_UI(Learner_GetLanguage(), LanturnName);
    case NATIONAL_DEX_LUVDISC: return LEARNER_UI(Learner_GetLanguage(), LuvdiscName);
    case NATIONAL_DEX_HORSEA: return LEARNER_UI(Learner_GetLanguage(), HorseaName);
    case NATIONAL_DEX_SEADRA: return LEARNER_UI(Learner_GetLanguage(), SeadraName);
    case NATIONAL_DEX_KINGDRA: return LEARNER_UI(Learner_GetLanguage(), KingdraName);
...
static const u8 *LearnerDexCategory(u16 dexNum, const u8 *fallback)
{
    ...
    case NATIONAL_DEX_LOTAD: return LEARNER_UI(Learner_GetLanguage(), LotadKind);
    case NATIONAL_DEX_SEEDOT: return LEARNER_UI(Learner_GetLanguage(), SeedotKind);
    case NATIONAL_DEX_RALTS: return LEARNER_UI(Learner_GetLanguage(), RaltsKind);
    case NATIONAL_DEX_SURSKIT: return LEARNER_UI(Learner_GetLanguage(), SurskitKind);
    case NATIONAL_DEX_TAILLOW: return LEARNER_UI(Learner_GetLanguage(), TaillowKind);
    case NATIONAL_DEX_WINGULL: return LEARNER_UI(Learner_GetLanguage(), WingullKind);
    case NATIONAL_DEX_SHROOMISH: return LEARNER_UI(Learner_GetLanguage(), ShroomishKind);
    case NATIONAL_DEX_WHISMUR: return LEARNER_UI(Learner_GetLanguage(), WhismurKind);
    case NATIONAL_DEX_SLAKOTH: return LEARNER_UI(Learner_GetLanguage(), SlakothKind);
    case NATIONAL_DEX_NINCADA: return LEARNER_UI(Learner_GetLanguage(), NincadaKind);
    case NATIONAL_DEX_SKITTY: return LEARNER_UI(Learner_GetLanguage(), SkittyKind);
    case NATIONAL_DEX_SABLEYE: return LEARNER_UI(Learner_GetLanguage(), SableyeKind);
    case NATIONAL_DEX_ZANGOOSE: return LEARNER_UI(Learner_GetLanguage(), ZangooseKind);
    case NATIONAL_DEX_SEVIPER: return LEARNER_UI(Learner_GetLanguage(), SeviperKind);
    case NATIONAL_DEX_BARBOACH: return LEARNER_UI(Learner_GetLanguage(), BarboachKind);
    case NATIONAL_DEX_CORPHISH: return LEARNER_UI(Learner_GetLanguage(), CorphishKind);
    case NATIONAL_DEX_BALTOY: return LEARNER_UI(Learner_GetLanguage(), BaltoyKind);
    case NATIONAL_DEX_LILEEP: return LEARNER_UI(Learner_GetLanguage(), LileepKind);
    case NATIONAL_DEX_ANORITH: return LEARNER_UI(Learner_GetLanguage(), AnorithKind);
    case NATIONAL_DEX_FEEBAS: return LEARNER_UI(Learner_GetLanguage(), FeebasKind);
    case NATIONAL_DEX_CASTFORM: return LEARNER_UI(Learner_GetLanguage(), CastformKind);
    case NATIONAL_DEX_KECLEON: return LEARNER_UI(Learner_GetLanguage(), KecleonKind);
    case NATIONAL_DEX_SHUPPET: return LEARNER_UI(Learner_GetLanguage(), ShuppetKind);
    case NATIONAL_DEX_DUSKULL: return LEARNER_UI(Learner_GetLanguage(), DuskullKind);
    case NATIONAL_DEX_TROPIUS: return LEARNER_UI(Learner_GetLanguage(), TropiusKind);
    case NATIONAL_DEX_CHIMECHO: return LEARNER_UI(Learner_GetLanguage(), ChimechoKind);
    case NATIONAL_DEX_ABSOL: return LEARNER_UI(Learner_GetLanguage(), AbsolKind);
    case NATIONAL_DEX_WYNAUT: return LEARNER_UI(Learner_GetLanguage(), WynautKind);
    case NATIONAL_DEX_SNORUNT: return LEARNER_UI(Learner_GetLanguage(), SnoruntKind);
    case NATIONAL_DEX_SPHEAL: return LEARNER_UI(Learner_GetLanguage(), SphealKind);
    case NATIONAL_DEX_CLAMPERL: return LEARNER_UI(Learner_GetLanguage(), ClamperlKind);
    case NATIONAL_DEX_BAGON: return LEARNER_UI(Learner_GetLanguage(), BagonKind);
    case NATIONAL_DEX_MAKUHITA: return LEARNER_UI(Learner_GetLanguage(), MakuhitaKind);
    case NATIONAL_DEX_ARON: return LEARNER_UI(Learner_GetLanguage(), AronKind);
    case NATIONAL_DEX_MEDITITE: return LEARNER_UI(Learner_GetLanguage(), MedititeKind);
    case NATIONAL_DEX_ELECTRIKE: return LEARNER_UI(Learner_GetLanguage(), ElectrikeKind);
    case NATIONAL_DEX_PLUSLE: return LEARNER_UI(Learner_GetLanguage(), PlusleKind);
    case NATIONAL_DEX_MINUN: return LEARNER_UI(Learner_GetLanguage(), MinunKind);
    case NATIONAL_DEX_ROSELIA: return LEARNER_UI(Learner_GetLanguage(), RoseliaKind);
    case NATIONAL_DEX_GULPIN: return LEARNER_UI(Learner_GetLanguage(), GulpinKind);
    case NATIONAL_DEX_NUMEL: return LEARNER_UI(Learner_GetLanguage(), NumelKind);
    case NATIONAL_DEX_SPOINK: return LEARNER_UI(Learner_GetLanguage(), SpoinkKind);
    case NATIONAL_DEX_TRAPINCH: return LEARNER_UI(Learner_GetLanguage(), TrapinchKind);
    case NATIONAL_DEX_SWABLU: return LEARNER_UI(Learner_GetLanguage(), SwabluKind);
    case NATIONAL_DEX_GROVYLE: return LEARNER_UI(Learner_GetLanguage(), GrovyleKind);
    case NATIONAL_DEX_SCEPTILE: return LEARNER_UI(Learner_GetLanguage(), SceptileKind);
    case NATIONAL_DEX_COMBUSKEN: return LEARNER_UI(Learner_GetLanguage(), CombuskenKind);
    case NATIONAL_DEX_BLAZIKEN: return LEARNER_UI(Learner_GetLanguage(), BlazikenKind);
    case NATIONAL_DEX_MARSHTOMP: return LEARNER_UI(Learner_GetLanguage(), MarshtompKind);
    case NATIONAL_DEX_SWAMPERT: return LEARNER_UI(Learner_GetLanguage(), SwampertKind);
    case NATIONAL_DEX_MIGHTYENA: return LEARNER_UI(Learner_GetLanguage(), MightyenaKind);
    case NATIONAL_DEX_LINOONE: return LEARNER_UI(Learner_GetLanguage(), LinooneKind);
    case NATIONAL_DEX_SILCOON: return LEARNER_UI(Learner_GetLanguage(), SilcoonKind);
    case NATIONAL_DEX_BEAUTIFLY: return LEARNER_UI(Learner_GetLanguage(), BeautiflyKind);
    case NATIONAL_DEX_CASCOON: return LEARNER_UI(Learner_GetLanguage(), CascoonKind);
    case NATIONAL_DEX_DUSTOX: return LEARNER_UI(Learner_GetLanguage(), DustoxKind);
    case NATIONAL_DEX_LOMBRE: return LEARNER_UI(Learner_GetLanguage(), LombreKind);
    case NATIONAL_DEX_LUDICOLO: return LEARNER_UI(Learner_GetLanguage(), LudicoloKind);
    case NATIONAL_DEX_NUZLEAF: return LEARNER_UI(Learner_GetLanguage(), NuzleafKind);
    case NATIONAL_DEX_SHIFTRY: return LEARNER_UI(Learner_GetLanguage(), ShiftryKind);
    case NATIONAL_DEX_KIRLIA: return LEARNER_UI(Learner_GetLanguage(), KirliaKind);
    case NATIONAL_DEX_GARDEVOIR: return LEARNER_UI(Learner_GetLanguage(), GardevoirKind);
    case NATIONAL_DEX_MASQUERAIN: return LEARNER_UI(Learner_GetLanguage(), MasquerainKind);
    case NATIONAL_DEX_SWELLOW: return LEARNER_UI(Learner_GetLanguage(), SwellowKind);
    case NATIONAL_DEX_PELIPPER: return LEARNER_UI(Learner_GetLanguage(), PelipperKind);
    case NATIONAL_DEX_BRELOOM: return LEARNER_UI(Learner_GetLanguage(), BreloomKind);
    case NATIONAL_DEX_LOUDRED: return LEARNER_UI(Learner_GetLanguage(), LoudredKind);
    case NATIONAL_DEX_EXPLOUD: return LEARNER_UI(Learner_GetLanguage(), ExploudKind);
    case NATIONAL_DEX_HARIYAMA: return LEARNER_UI(Learner_GetLanguage(), HariyamaKind);
    case NATIONAL_DEX_LAIRON: return LEARNER_UI(Learner_GetLanguage(), LaironKind);
    case NATIONAL_DEX_AGGRON: return LEARNER_UI(Learner_GetLanguage(), AggronKind);
    case NATIONAL_DEX_MEDICHAM: return LEARNER_UI(Learner_GetLanguage(), MedichamKind);
    case NATIONAL_DEX_MANECTRIC: return LEARNER_UI(Learner_GetLanguage(), ManectricKind);
    case NATIONAL_DEX_SWALOT: return LEARNER_UI(Learner_GetLanguage(), SwalotKind);
    case NATIONAL_DEX_CAMERUPT: return LEARNER_UI(Learner_GetLanguage(), CameruptKind);
    case NATIONAL_DEX_GRUMPIG: return LEARNER_UI(Learner_GetLanguage(), GrumpigKind);
    case NATIONAL_DEX_VIBRAVA: return LEARNER_UI(Learner_GetLanguage(), VibravaKind);
    case NATIONAL_DEX_FLYGON: return LEARNER_UI(Learner_GetLanguage(), FlygonKind);
    case NATIONAL_DEX_ALTARIA: return LEARNER_UI(Learner_GetLanguage(), AltariaKind);
    case NATIONAL_DEX_GLALIE: return LEARNER_UI(Learner_GetLanguage(), GlalieKind);
    case NATIONAL_DEX_WALREIN: return LEARNER_UI(Learner_GetLanguage(), WalreinKind);
    case NATIONAL_DEX_HUNTAIL: return LEARNER_UI(Learner_GetLanguage(), HuntailKind);
    case NATIONAL_DEX_GOREBYSS: return LEARNER_UI(Learner_GetLanguage(), GorebyssKind);
    case NATIONAL_DEX_SHELGON: return LEARNER_UI(Learner_GetLanguage(), ShelgonKind);
    case NATIONAL_DEX_SALAMENCE: return LEARNER_UI(Learner_GetLanguage(), SalamenceKind);
    case NATIONAL_DEX_CRADILY: return LEARNER_UI(Learner_GetLanguage(), CradilyKind);
    case NATIONAL_DEX_ARMALDO: return LEARNER_UI(Learner_GetLanguage(), ArmaldoKind);
    case NATIONAL_DEX_BANETTE: return LEARNER_UI(Learner_GetLanguage(), BanetteKind);
    case NATIONAL_DEX_DUSCLOPS: return LEARNER_UI(Learner_GetLanguage(), DusclopsKind);
    case NATIONAL_DEX_METANG: return LEARNER_UI(Learner_GetLanguage(), MetangKind);
    case NATIONAL_DEX_METAGROSS: return LEARNER_UI(Learner_GetLanguage(), MetagrossKind);
    case NATIONAL_DEX_REGIROCK: return LEARNER_UI(Learner_GetLanguage(), RegirockKind);
    case NATIONAL_DEX_REGICE: return LEARNER_UI(Learner_GetLanguage(), RegiceKind);
    case NATIONAL_DEX_REGISTEEL: return LEARNER_UI(Learner_GetLanguage(), RegisteelKind);
    case NATIONAL_DEX_LATIAS: return LEARNER_UI(Learner_GetLanguage(), LatiasKind);
    ...
    case NATIONAL_DEX_VIGOROTH: return LEARNER_UI(Learner_GetLanguage(), VigorothKind);
    case NATIONAL_DEX_SLAKING: return LEARNER_UI(Learner_GetLanguage(), SlakingKind);
    case NATIONAL_DEX_ABRA: return LEARNER_UI(Learner_GetLanguage(), AbraKind);
    case NATIONAL_DEX_KADABRA: return LEARNER_UI(Learner_GetLanguage(), KadabraKind);
    case NATIONAL_DEX_ALAKAZAM: return LEARNER_UI(Learner_GetLanguage(), AlakazamKind);
    case NATIONAL_DEX_NINJASK: return LEARNER_UI(Learner_GetLanguage(), NinjaskKind);
    case NATIONAL_DEX_SHEDINJA: return LEARNER_UI(Learner_GetLanguage(), ShedinjaKind);
    case NATIONAL_DEX_GOLDEEN: return LEARNER_UI(Learner_GetLanguage(), GoldeenKind);
    case NATIONAL_DEX_SEAKING: return LEARNER_UI(Learner_GetLanguage(), SeakingKind);
    case NATIONAL_DEX_MAGIKARP: return LEARNER_UI(Learner_GetLanguage(), MagikarpKind);
    case NATIONAL_DEX_GYARADOS: return LEARNER_UI(Learner_GetLanguage(), GyaradosKind);
    case NATIONAL_DEX_AZURILL: return LEARNER_UI(Learner_GetLanguage(), AzurillKind);
    case NATIONAL_DEX_MARILL: return LEARNER_UI(Learner_GetLanguage(), MarillKind);
    case NATIONAL_DEX_AZUMARILL: return LEARNER_UI(Learner_GetLanguage(), AzumarillKind);
    case NATIONAL_DEX_GEODUDE: return LEARNER_UI(Learner_GetLanguage(), GeodudeKind);
    case NATIONAL_DEX_GRAVELER: return LEARNER_UI(Learner_GetLanguage(), GravelerKind);
    case NATIONAL_DEX_GOLEM: return LEARNER_UI(Learner_GetLanguage(), GolemKind);
    ...
    case NATIONAL_DEX_STARMIE: return LEARNER_UI(Learner_GetLanguage(), StarmieKind);
    case NATIONAL_DEX_VULPIX: return LEARNER_UI(Learner_GetLanguage(), VulpixKind);
    case NATIONAL_DEX_NINETALES: return LEARNER_UI(Learner_GetLanguage(), NinetalesKind);
    case NATIONAL_DEX_PICHU: return LEARNER_UI(Learner_GetLanguage(), PichuKind);
    case NATIONAL_DEX_PIKACHU: return LEARNER_UI(Learner_GetLanguage(), PikachuKind);
    case NATIONAL_DEX_RAICHU: return LEARNER_UI(Learner_GetLanguage(), RaichuKind);
    case NATIONAL_DEX_PSYDUCK: return LEARNER_UI(Learner_GetLanguage(), PsyduckKind);
    case NATIONAL_DEX_GOLDUCK: return LEARNER_UI(Learner_GetLanguage(), GolduckKind);
    case NATIONAL_DEX_WOBBUFFET: return LEARNER_UI(Learner_GetLanguage(), WobbuffetKind);
    case NATIONAL_DEX_NATU: return LEARNER_UI(Learner_GetLanguage(), NatuKind);
    case NATIONAL_DEX_XATU: return LEARNER_UI(Learner_GetLanguage(), XatuKind);
    case NATIONAL_DEX_GIRAFARIG: return LEARNER_UI(Learner_GetLanguage(), GirafarigKind);
    case NATIONAL_DEX_PHANPY: return LEARNER_UI(Learner_GetLanguage(), PhanpyKind);
    case NATIONAL_DEX_DONPHAN: return LEARNER_UI(Learner_GetLanguage(), DonphanKind);
    case NATIONAL_DEX_PINSIR: return LEARNER_UI(Learner_GetLanguage(), PinsirKind);
    case NATIONAL_DEX_HERACROSS: return LEARNER_UI(Learner_GetLanguage(), HeracrossKind);
    case NATIONAL_DEX_RHYHORN: return LEARNER_UI(Learner_GetLanguage(), RhyhornKind);
    case NATIONAL_DEX_RHYDON: return LEARNER_UI(Learner_GetLanguage(), RhydonKind);
    case NATIONAL_DEX_SEALEO: return LEARNER_UI(Learner_GetLanguage(), SealeoKind);
    case NATIONAL_DEX_RELICANTH: return LEARNER_UI(Learner_GetLanguage(), RelicanthKind);
    case NATIONAL_DEX_CORSOLA: return LEARNER_UI(Learner_GetLanguage(), CorsolaKind);
    case NATIONAL_DEX_CHINCHOU: return LEARNER_UI(Learner_GetLanguage(), ChinchouKind);
    case NATIONAL_DEX_LANTURN: return LEARNER_UI(Learner_GetLanguage(), LanturnKind);
    case NATIONAL_DEX_LUVDISC: return LEARNER_UI(Learner_GetLanguage(), LuvdiscKind);
    case NATIONAL_DEX_HORSEA: return LEARNER_UI(Learner_GetLanguage(), HorseaKind);
    case NATIONAL_DEX_SEADRA: return LEARNER_UI(Learner_GetLanguage(), SeadraKind);
    case NATIONAL_DEX_KINGDRA: return LEARNER_UI(Learner_GetLanguage(), KingdraKind);
    default: return fallback;
    }
}
...
static const u8 *LearnerDexDescription(u16 dexNum, u8 page, const u8 *fallback)
{
    ...
    case NATIONAL_DEX_LOTAD: return page ? LEARNER_UI(Learner_GetLanguage(), LotadDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), LotadDexPageOne);
    case NATIONAL_DEX_SEEDOT: return page ? LEARNER_UI(Learner_GetLanguage(), SeedotDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SeedotDexPageOne);
    case NATIONAL_DEX_RALTS: return page ? LEARNER_UI(Learner_GetLanguage(), RaltsDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), RaltsDexPageOne);
    case NATIONAL_DEX_SURSKIT: return page ? LEARNER_UI(Learner_GetLanguage(), SurskitDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SurskitDexPageOne);
    case NATIONAL_DEX_TAILLOW: return page ? LEARNER_UI(Learner_GetLanguage(), TaillowDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), TaillowDexPageOne);
    case NATIONAL_DEX_WINGULL: return page ? LEARNER_UI(Learner_GetLanguage(), WingullDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), WingullDexPageOne);
    case NATIONAL_DEX_SHROOMISH: return page ? LEARNER_UI(Learner_GetLanguage(), ShroomishDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), ShroomishDexPageOne);
    case NATIONAL_DEX_WHISMUR: return page ? LEARNER_UI(Learner_GetLanguage(), WhismurDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), WhismurDexPageOne);
    case NATIONAL_DEX_SLAKOTH: return page ? LEARNER_UI(Learner_GetLanguage(), SlakothDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SlakothDexPageOne);
    case NATIONAL_DEX_NINCADA: return page ? LEARNER_UI(Learner_GetLanguage(), NincadaDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), NincadaDexPageOne);
    case NATIONAL_DEX_SKITTY: return page ? LEARNER_UI(Learner_GetLanguage(), SkittyDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SkittyDexPageOne);
    case NATIONAL_DEX_SABLEYE: return page ? LEARNER_UI(Learner_GetLanguage(), SableyeDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SableyeDexPageOne);
    case NATIONAL_DEX_ZANGOOSE: return page ? LEARNER_UI(Learner_GetLanguage(), ZangooseDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), ZangooseDexPageOne);
    case NATIONAL_DEX_SEVIPER: return page ? LEARNER_UI(Learner_GetLanguage(), SeviperDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SeviperDexPageOne);
    case NATIONAL_DEX_BARBOACH: return page ? LEARNER_UI(Learner_GetLanguage(), BarboachDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), BarboachDexPageOne);
    case NATIONAL_DEX_CORPHISH: return page ? LEARNER_UI(Learner_GetLanguage(), CorphishDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), CorphishDexPageOne);
    case NATIONAL_DEX_BALTOY: return page ? LEARNER_UI(Learner_GetLanguage(), BaltoyDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), BaltoyDexPageOne);
    case NATIONAL_DEX_LILEEP: return page ? LEARNER_UI(Learner_GetLanguage(), LileepDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), LileepDexPageOne);
    case NATIONAL_DEX_ANORITH: return page ? LEARNER_UI(Learner_GetLanguage(), AnorithDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), AnorithDexPageOne);
    case NATIONAL_DEX_FEEBAS: return page ? LEARNER_UI(Learner_GetLanguage(), FeebasDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), FeebasDexPageOne);
    case NATIONAL_DEX_CASTFORM: return page ? LEARNER_UI(Learner_GetLanguage(), CastformDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), CastformDexPageOne);
    case NATIONAL_DEX_KECLEON: return page ? LEARNER_UI(Learner_GetLanguage(), KecleonDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), KecleonDexPageOne);
    case NATIONAL_DEX_SHUPPET: return page ? LEARNER_UI(Learner_GetLanguage(), ShuppetDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), ShuppetDexPageOne);
    case NATIONAL_DEX_DUSKULL: return page ? LEARNER_UI(Learner_GetLanguage(), DuskullDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), DuskullDexPageOne);
    case NATIONAL_DEX_TROPIUS: return page ? LEARNER_UI(Learner_GetLanguage(), TropiusDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), TropiusDexPageOne);
    case NATIONAL_DEX_CHIMECHO: return page ? LEARNER_UI(Learner_GetLanguage(), ChimechoDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), ChimechoDexPageOne);
    case NATIONAL_DEX_ABSOL: return page ? LEARNER_UI(Learner_GetLanguage(), AbsolDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), AbsolDexPageOne);
    case NATIONAL_DEX_WYNAUT: return page ? LEARNER_UI(Learner_GetLanguage(), WynautDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), WynautDexPageOne);
    case NATIONAL_DEX_SNORUNT: return page ? LEARNER_UI(Learner_GetLanguage(), SnoruntDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SnoruntDexPageOne);
    case NATIONAL_DEX_SPHEAL: return page ? LEARNER_UI(Learner_GetLanguage(), SphealDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SphealDexPageOne);
    case NATIONAL_DEX_CLAMPERL: return page ? LEARNER_UI(Learner_GetLanguage(), ClamperlDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), ClamperlDexPageOne);
    case NATIONAL_DEX_BAGON: return page ? LEARNER_UI(Learner_GetLanguage(), BagonDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), BagonDexPageOne);
    case NATIONAL_DEX_MAKUHITA: return page ? LEARNER_UI(Learner_GetLanguage(), MakuhitaDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), MakuhitaDexPageOne);
    case NATIONAL_DEX_ARON: return page ? LEARNER_UI(Learner_GetLanguage(), AronDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), AronDexPageOne);
    case NATIONAL_DEX_MEDITITE: return page ? LEARNER_UI(Learner_GetLanguage(), MedititeDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), MedititeDexPageOne);
    case NATIONAL_DEX_ELECTRIKE: return page ? LEARNER_UI(Learner_GetLanguage(), ElectrikeDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), ElectrikeDexPageOne);
    case NATIONAL_DEX_PLUSLE: return page ? LEARNER_UI(Learner_GetLanguage(), PlusleDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), PlusleDexPageOne);
    case NATIONAL_DEX_MINUN: return page ? LEARNER_UI(Learner_GetLanguage(), MinunDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), MinunDexPageOne);
    case NATIONAL_DEX_ROSELIA: return page ? LEARNER_UI(Learner_GetLanguage(), RoseliaDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), RoseliaDexPageOne);
    case NATIONAL_DEX_GULPIN: return page ? LEARNER_UI(Learner_GetLanguage(), GulpinDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), GulpinDexPageOne);
    case NATIONAL_DEX_NUMEL: return page ? LEARNER_UI(Learner_GetLanguage(), NumelDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), NumelDexPageOne);
    case NATIONAL_DEX_SPOINK: return page ? LEARNER_UI(Learner_GetLanguage(), SpoinkDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SpoinkDexPageOne);
    case NATIONAL_DEX_TRAPINCH: return page ? LEARNER_UI(Learner_GetLanguage(), TrapinchDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), TrapinchDexPageOne);
    case NATIONAL_DEX_SWABLU: return page ? LEARNER_UI(Learner_GetLanguage(), SwabluDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SwabluDexPageOne);
    case NATIONAL_DEX_GROVYLE: return page ? LEARNER_UI(Learner_GetLanguage(), GrovyleDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), GrovyleDexPageOne);
    case NATIONAL_DEX_SCEPTILE: return page ? LEARNER_UI(Learner_GetLanguage(), SceptileDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SceptileDexPageOne);
    case NATIONAL_DEX_COMBUSKEN: return page ? LEARNER_UI(Learner_GetLanguage(), CombuskenDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), CombuskenDexPageOne);
    case NATIONAL_DEX_BLAZIKEN: return page ? LEARNER_UI(Learner_GetLanguage(), BlazikenDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), BlazikenDexPageOne);
    case NATIONAL_DEX_MARSHTOMP: return page ? LEARNER_UI(Learner_GetLanguage(), MarshtompDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), MarshtompDexPageOne);
    case NATIONAL_DEX_SWAMPERT: return page ? LEARNER_UI(Learner_GetLanguage(), SwampertDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SwampertDexPageOne);
    case NATIONAL_DEX_MIGHTYENA: return page ? LEARNER_UI(Learner_GetLanguage(), MightyenaDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), MightyenaDexPageOne);
    case NATIONAL_DEX_LINOONE: return page ? LEARNER_UI(Learner_GetLanguage(), LinooneDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), LinooneDexPageOne);
    case NATIONAL_DEX_SILCOON: return page ? LEARNER_UI(Learner_GetLanguage(), SilcoonDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SilcoonDexPageOne);
    case NATIONAL_DEX_BEAUTIFLY: return page ? LEARNER_UI(Learner_GetLanguage(), BeautiflyDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), BeautiflyDexPageOne);
    case NATIONAL_DEX_CASCOON: return page ? LEARNER_UI(Learner_GetLanguage(), CascoonDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), CascoonDexPageOne);
    case NATIONAL_DEX_DUSTOX: return page ? LEARNER_UI(Learner_GetLanguage(), DustoxDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), DustoxDexPageOne);
    case NATIONAL_DEX_LOMBRE: return page ? LEARNER_UI(Learner_GetLanguage(), LombreDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), LombreDexPageOne);
    case NATIONAL_DEX_LUDICOLO: return page ? LEARNER_UI(Learner_GetLanguage(), LudicoloDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), LudicoloDexPageOne);
    case NATIONAL_DEX_NUZLEAF: return page ? LEARNER_UI(Learner_GetLanguage(), NuzleafDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), NuzleafDexPageOne);
    case NATIONAL_DEX_SHIFTRY: return page ? LEARNER_UI(Learner_GetLanguage(), ShiftryDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), ShiftryDexPageOne);
    case NATIONAL_DEX_KIRLIA: return page ? LEARNER_UI(Learner_GetLanguage(), KirliaDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), KirliaDexPageOne);
    case NATIONAL_DEX_GARDEVOIR: return page ? LEARNER_UI(Learner_GetLanguage(), GardevoirDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), GardevoirDexPageOne);
    case NATIONAL_DEX_MASQUERAIN: return page ? LEARNER_UI(Learner_GetLanguage(), MasquerainDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), MasquerainDexPageOne);
    case NATIONAL_DEX_SWELLOW: return page ? LEARNER_UI(Learner_GetLanguage(), SwellowDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SwellowDexPageOne);
    case NATIONAL_DEX_PELIPPER: return page ? LEARNER_UI(Learner_GetLanguage(), PelipperDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), PelipperDexPageOne);
    ...
    case NATIONAL_DEX_VIGOROTH: return page ? LEARNER_UI(Learner_GetLanguage(), VigorothDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), VigorothDexPageOne);
    case NATIONAL_DEX_SLAKING: return page ? LEARNER_UI(Learner_GetLanguage(), SlakingDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SlakingDexPageOne);
    case NATIONAL_DEX_ABRA: return page ? LEARNER_UI(Learner_GetLanguage(), AbraDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), AbraDexPageOne);
    case NATIONAL_DEX_KADABRA: return page ? LEARNER_UI(Learner_GetLanguage(), KadabraDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), KadabraDexPageOne);
    case NATIONAL_DEX_ALAKAZAM: return page ? LEARNER_UI(Learner_GetLanguage(), AlakazamDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), AlakazamDexPageOne);
    case NATIONAL_DEX_NINJASK: return page ? LEARNER_UI(Learner_GetLanguage(), NinjaskDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), NinjaskDexPageOne);
    case NATIONAL_DEX_SHEDINJA: return page ? LEARNER_UI(Learner_GetLanguage(), ShedinjaDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), ShedinjaDexPageOne);
    case NATIONAL_DEX_GOLDEEN: return page ? LEARNER_UI(Learner_GetLanguage(), GoldeenDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), GoldeenDexPageOne);
    case NATIONAL_DEX_SEAKING: return page ? LEARNER_UI(Learner_GetLanguage(), SeakingDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SeakingDexPageOne);
    case NATIONAL_DEX_MAGIKARP: return page ? LEARNER_UI(Learner_GetLanguage(), MagikarpDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), MagikarpDexPageOne);
    case NATIONAL_DEX_GYARADOS: return page ? LEARNER_UI(Learner_GetLanguage(), GyaradosDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), GyaradosDexPageOne);
    case NATIONAL_DEX_AZURILL: return page ? LEARNER_UI(Learner_GetLanguage(), AzurillDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), AzurillDexPageOne);
    case NATIONAL_DEX_MARILL: return page ? LEARNER_UI(Learner_GetLanguage(), MarillDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), MarillDexPageOne);
    case NATIONAL_DEX_AZUMARILL: return page ? LEARNER_UI(Learner_GetLanguage(), AzumarillDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), AzumarillDexPageOne);
    case NATIONAL_DEX_GEODUDE: return page ? LEARNER_UI(Learner_GetLanguage(), GeodudeDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), GeodudeDexPageOne);
    case NATIONAL_DEX_GRAVELER: return page ? LEARNER_UI(Learner_GetLanguage(), GravelerDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), GravelerDexPageOne);
    case NATIONAL_DEX_GOLEM: return page ? LEARNER_UI(Learner_GetLanguage(), GolemDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), GolemDexPageOne);
    ...
    case NATIONAL_DEX_STARMIE: return page ? LEARNER_UI(Learner_GetLanguage(), StarmieDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), StarmieDexPageOne);
    case NATIONAL_DEX_VULPIX: return page ? LEARNER_UI(Learner_GetLanguage(), VulpixDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), VulpixDexPageOne);
    case NATIONAL_DEX_NINETALES: return page ? LEARNER_UI(Learner_GetLanguage(), NinetalesDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), NinetalesDexPageOne);
    case NATIONAL_DEX_PICHU: return page ? LEARNER_UI(Learner_GetLanguage(), PichuDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), PichuDexPageOne);
    case NATIONAL_DEX_PIKACHU: return page ? LEARNER_UI(Learner_GetLanguage(), PikachuDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), PikachuDexPageOne);
    case NATIONAL_DEX_RAICHU: return page ? LEARNER_UI(Learner_GetLanguage(), RaichuDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), RaichuDexPageOne);
    case NATIONAL_DEX_PSYDUCK: return page ? LEARNER_UI(Learner_GetLanguage(), PsyduckDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), PsyduckDexPageOne);
    case NATIONAL_DEX_GOLDUCK: return page ? LEARNER_UI(Learner_GetLanguage(), GolduckDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), GolduckDexPageOne);
    case NATIONAL_DEX_WOBBUFFET: return page ? LEARNER_UI(Learner_GetLanguage(), WobbuffetDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), WobbuffetDexPageOne);
    case NATIONAL_DEX_NATU: return page ? LEARNER_UI(Learner_GetLanguage(), NatuDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), NatuDexPageOne);
    case NATIONAL_DEX_XATU: return page ? LEARNER_UI(Learner_GetLanguage(), XatuDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), XatuDexPageOne);
    case NATIONAL_DEX_GIRAFARIG: return page ? LEARNER_UI(Learner_GetLanguage(), GirafarigDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), GirafarigDexPageOne);
    case NATIONAL_DEX_PHANPY: return page ? LEARNER_UI(Learner_GetLanguage(), PhanpyDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), PhanpyDexPageOne);
    case NATIONAL_DEX_DONPHAN: return page ? LEARNER_UI(Learner_GetLanguage(), DonphanDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), DonphanDexPageOne);
    case NATIONAL_DEX_PINSIR: return page ? LEARNER_UI(Learner_GetLanguage(), PinsirDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), PinsirDexPageOne);
    case NATIONAL_DEX_HERACROSS: return page ? LEARNER_UI(Learner_GetLanguage(), HeracrossDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), HeracrossDexPageOne);
    case NATIONAL_DEX_RHYHORN: return page ? LEARNER_UI(Learner_GetLanguage(), RhyhornDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), RhyhornDexPageOne);
    case NATIONAL_DEX_RHYDON: return page ? LEARNER_UI(Learner_GetLanguage(), RhydonDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), RhydonDexPageOne);
    case NATIONAL_DEX_SEALEO: return page ? LEARNER_UI(Learner_GetLanguage(), SealeoDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SealeoDexPageOne);
    case NATIONAL_DEX_RELICANTH: return page ? LEARNER_UI(Learner_GetLanguage(), RelicanthDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), RelicanthDexPageOne);
    case NATIONAL_DEX_CORSOLA: return page ? LEARNER_UI(Learner_GetLanguage(), CorsolaDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), CorsolaDexPageOne);
    case NATIONAL_DEX_CHINCHOU: return page ? LEARNER_UI(Learner_GetLanguage(), ChinchouDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), ChinchouDexPageOne);
    case NATIONAL_DEX_LANTURN: return page ? LEARNER_UI(Learner_GetLanguage(), LanturnDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), LanturnDexPageOne);
    case NATIONAL_DEX_LUVDISC: return page ? LEARNER_UI(Learner_GetLanguage(), LuvdiscDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), LuvdiscDexPageOne);
    case NATIONAL_DEX_HORSEA: return page ? LEARNER_UI(Learner_GetLanguage(), HorseaDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), HorseaDexPageOne);
    case NATIONAL_DEX_SEADRA: return page ? LEARNER_UI(Learner_GetLanguage(), SeadraDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), SeadraDexPageOne);
    case NATIONAL_DEX_KINGDRA: return page ? LEARNER_UI(Learner_GetLanguage(), KingdraDexPageTwo) : LEARNER_UI(Learner_GetLanguage(), KingdraDexPageOne);
    default: return fallback;
    }
}
#endif
