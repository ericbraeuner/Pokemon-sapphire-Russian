...
static const u8 *SummaryAbilityName(u8 ability)
{
    ...
    case ABILITY_STENCH: return LEARNER_UI(Learner_GetLanguage(), AbilityStench);
    case ABILITY_DRIZZLE: return LEARNER_UI(Learner_GetLanguage(), AbilityDrizzle);
    case ABILITY_SPEED_BOOST: return LEARNER_UI(Learner_GetLanguage(), AbilitySpeedBoost);
    case ABILITY_BATTLE_ARMOR: return LEARNER_UI(Learner_GetLanguage(), AbilityBattleArmor);
    case ABILITY_STURDY: return LEARNER_UI(Learner_GetLanguage(), AbilitySturdy);
    case ABILITY_VOLT_ABSORB: return LEARNER_UI(Learner_GetLanguage(), AbilityVoltAbsorb);
    case ABILITY_WATER_ABSORB: return LEARNER_UI(Learner_GetLanguage(), AbilityWaterAbsorb);
    case ABILITY_OBLIVIOUS: return LEARNER_UI(Learner_GetLanguage(), AbilityOblivious);
    case ABILITY_INSOMNIA: return LEARNER_UI(Learner_GetLanguage(), AbilityInsomnia);
    case ABILITY_COLOR_CHANGE: return LEARNER_UI(Learner_GetLanguage(), AbilityColorChange);
    case ABILITY_IMMUNITY: return LEARNER_UI(Learner_GetLanguage(), AbilityImmunity);
    case ABILITY_OWN_TEMPO: return LEARNER_UI(Learner_GetLanguage(), AbilityOwnTempo);
    case ABILITY_SUCTION_CUPS: return LEARNER_UI(Learner_GetLanguage(), AbilitySuctionCups);
    case ABILITY_SHADOW_TAG: return LEARNER_UI(Learner_GetLanguage(), AbilityShadowTag);
    case ABILITY_ROUGH_SKIN: return LEARNER_UI(Learner_GetLanguage(), AbilityRoughSkin);
    case ABILITY_WONDER_GUARD: return LEARNER_UI(Learner_GetLanguage(), AbilityWonderGuard);
    case ABILITY_LEVITATE: return LEARNER_UI(Learner_GetLanguage(), AbilityLevitate);
    case ABILITY_SYNCHRONIZE: return LEARNER_UI(Learner_GetLanguage(), AbilitySynchronize);
    case ABILITY_CLEAR_BODY: return LEARNER_UI(Learner_GetLanguage(), AbilityClearBody);
    case ABILITY_NATURAL_CURE: return LEARNER_UI(Learner_GetLanguage(), AbilityNaturalCure);
    case ABILITY_LIGHTNING_ROD: return LEARNER_UI(Learner_GetLanguage(), AbilityLightningRod);
    case ABILITY_SERENE_GRACE: return LEARNER_UI(Learner_GetLanguage(), AbilitySereneGrace);
    case ABILITY_SWIFT_SWIM: return LEARNER_UI(Learner_GetLanguage(), AbilitySwiftSwim);
    case ABILITY_ILLUMINATE: return LEARNER_UI(Learner_GetLanguage(), AbilityIlluminate);
    case ABILITY_TRACE: return LEARNER_UI(Learner_GetLanguage(), AbilityTrace);
    case ABILITY_HUGE_POWER: return LEARNER_UI(Learner_GetLanguage(), AbilityHugePower);
    case ABILITY_MAGMA_ARMOR: return LEARNER_UI(Learner_GetLanguage(), AbilityMagmaArmor);
    case ABILITY_WATER_VEIL: return LEARNER_UI(Learner_GetLanguage(), AbilityWaterVeil);
    case ABILITY_MAGNET_PULL: return LEARNER_UI(Learner_GetLanguage(), AbilityMagnetPull);
    case ABILITY_SOUNDPROOF: return LEARNER_UI(Learner_GetLanguage(), AbilitySoundproof);
    case ABILITY_RAIN_DISH: return LEARNER_UI(Learner_GetLanguage(), AbilityRainDish);
    case ABILITY_SAND_STREAM: return LEARNER_UI(Learner_GetLanguage(), AbilitySandStream);
    case ABILITY_PRESSURE: return LEARNER_UI(Learner_GetLanguage(), AbilityPressure);
    case ABILITY_THICK_FAT: return LEARNER_UI(Learner_GetLanguage(), AbilityThickFat);
    case ABILITY_EARLY_BIRD: return LEARNER_UI(Learner_GetLanguage(), AbilityEarlyBird);
    case ABILITY_FLAME_BODY: return LEARNER_UI(Learner_GetLanguage(), AbilityFlameBody);
    case ABILITY_HYPER_CUTTER: return LEARNER_UI(Learner_GetLanguage(), AbilityHyperCutter);
    case ABILITY_TRUANT: return LEARNER_UI(Learner_GetLanguage(), AbilityTruant);
    case ABILITY_HUSTLE: return LEARNER_UI(Learner_GetLanguage(), AbilityHustle);
    case ABILITY_PLUS: return LEARNER_UI(Learner_GetLanguage(), AbilityPlus);
    case ABILITY_MINUS: return LEARNER_UI(Learner_GetLanguage(), AbilityMinus);
    case ABILITY_FORECAST: return LEARNER_UI(Learner_GetLanguage(), AbilityForecast);
    case ABILITY_STICKY_HOLD: return LEARNER_UI(Learner_GetLanguage(), AbilityStickyHold);
    case ABILITY_MARVEL_SCALE: return LEARNER_UI(Learner_GetLanguage(), AbilityMarvelScale);
    case ABILITY_LIQUID_OOZE: return LEARNER_UI(Learner_GetLanguage(), AbilityLiquidOoze);
    case ABILITY_ROCK_HEAD: return LEARNER_UI(Learner_GetLanguage(), AbilityRockHead);
    case ABILITY_DROUGHT: return LEARNER_UI(Learner_GetLanguage(), AbilityDrought);
    case ABILITY_WHITE_SMOKE: return LEARNER_UI(Learner_GetLanguage(), AbilityWhiteSmoke);
    case ABILITY_PURE_POWER: return LEARNER_UI(Learner_GetLanguage(), AbilityPurePower);
    case ABILITY_SHELL_ARMOR: return LEARNER_UI(Learner_GetLanguage(), AbilityShellArmor);
    case ABILITY_CACOPHONY: return LEARNER_UI(Learner_GetLanguage(), AbilityCacophony);
    case ABILITY_AIR_LOCK: return LEARNER_UI(Learner_GetLanguage(), AbilityAirLock);
...
static const u8 *SummaryAbilityDescription(u8 ability)
{
    ...
    case ABILITY_STENCH: return LEARNER_UI(Learner_GetLanguage(), AbilityStenchDesc);
    case ABILITY_DRIZZLE: return LEARNER_UI(Learner_GetLanguage(), AbilityDrizzleDesc);
    case ABILITY_SPEED_BOOST: return LEARNER_UI(Learner_GetLanguage(), AbilitySpeedBoostDesc);
    case ABILITY_BATTLE_ARMOR: return LEARNER_UI(Learner_GetLanguage(), AbilityBattleArmorDesc);
    case ABILITY_STURDY: return LEARNER_UI(Learner_GetLanguage(), AbilitySturdyDesc);
    case ABILITY_VOLT_ABSORB: return LEARNER_UI(Learner_GetLanguage(), AbilityVoltAbsorbDesc);
    case ABILITY_WATER_ABSORB: return LEARNER_UI(Learner_GetLanguage(), AbilityWaterAbsorbDesc);
    case ABILITY_OBLIVIOUS: return LEARNER_UI(Learner_GetLanguage(), AbilityObliviousDesc);
    case ABILITY_INSOMNIA: return LEARNER_UI(Learner_GetLanguage(), AbilityInsomniaDesc);
    case ABILITY_COLOR_CHANGE: return LEARNER_UI(Learner_GetLanguage(), AbilityColorChangeDesc);
    case ABILITY_IMMUNITY: return LEARNER_UI(Learner_GetLanguage(), AbilityImmunityDesc);
    case ABILITY_OWN_TEMPO: return LEARNER_UI(Learner_GetLanguage(), AbilityOwnTempoDesc);
    case ABILITY_SUCTION_CUPS: return LEARNER_UI(Learner_GetLanguage(), AbilitySuctionCupsDesc);
    case ABILITY_SHADOW_TAG: return LEARNER_UI(Learner_GetLanguage(), AbilityShadowTagDesc);
    case ABILITY_ROUGH_SKIN: return LEARNER_UI(Learner_GetLanguage(), AbilityRoughSkinDesc);
    case ABILITY_WONDER_GUARD: return LEARNER_UI(Learner_GetLanguage(), AbilityWonderGuardDesc);
    case ABILITY_LEVITATE: return LEARNER_UI(Learner_GetLanguage(), AbilityLevitateDesc);
    case ABILITY_SYNCHRONIZE: return LEARNER_UI(Learner_GetLanguage(), AbilitySynchronizeDesc);
    case ABILITY_CLEAR_BODY: return LEARNER_UI(Learner_GetLanguage(), AbilityClearBodyDesc);
    case ABILITY_NATURAL_CURE: return LEARNER_UI(Learner_GetLanguage(), AbilityNaturalCureDesc);
    case ABILITY_LIGHTNING_ROD: return LEARNER_UI(Learner_GetLanguage(), AbilityLightningRodDesc);
    case ABILITY_SERENE_GRACE: return LEARNER_UI(Learner_GetLanguage(), AbilitySereneGraceDesc);
    case ABILITY_SWIFT_SWIM: return LEARNER_UI(Learner_GetLanguage(), AbilitySwiftSwimDesc);
    case ABILITY_ILLUMINATE: return LEARNER_UI(Learner_GetLanguage(), AbilityIlluminateDesc);
    case ABILITY_TRACE: return LEARNER_UI(Learner_GetLanguage(), AbilityTraceDesc);
    case ABILITY_HUGE_POWER: return LEARNER_UI(Learner_GetLanguage(), AbilityHugePowerDesc);
    case ABILITY_MAGMA_ARMOR: return LEARNER_UI(Learner_GetLanguage(), AbilityMagmaArmorDesc);
    case ABILITY_WATER_VEIL: return LEARNER_UI(Learner_GetLanguage(), AbilityWaterVeilDesc);
    case ABILITY_MAGNET_PULL: return LEARNER_UI(Learner_GetLanguage(), AbilityMagnetPullDesc);
    case ABILITY_SOUNDPROOF: return LEARNER_UI(Learner_GetLanguage(), AbilitySoundproofDesc);
    case ABILITY_RAIN_DISH: return LEARNER_UI(Learner_GetLanguage(), AbilityRainDishDesc);
    case ABILITY_SAND_STREAM: return LEARNER_UI(Learner_GetLanguage(), AbilitySandStreamDesc);
    case ABILITY_PRESSURE: return LEARNER_UI(Learner_GetLanguage(), AbilityPressureDesc);
    case ABILITY_THICK_FAT: return LEARNER_UI(Learner_GetLanguage(), AbilityThickFatDesc);
    case ABILITY_EARLY_BIRD: return LEARNER_UI(Learner_GetLanguage(), AbilityEarlyBirdDesc);
    case ABILITY_FLAME_BODY: return LEARNER_UI(Learner_GetLanguage(), AbilityFlameBodyDesc);
    case ABILITY_HYPER_CUTTER: return LEARNER_UI(Learner_GetLanguage(), AbilityHyperCutterDesc);
    case ABILITY_TRUANT: return LEARNER_UI(Learner_GetLanguage(), AbilityTruantDesc);
    case ABILITY_HUSTLE: return LEARNER_UI(Learner_GetLanguage(), AbilityHustleDesc);
    case ABILITY_PLUS: return LEARNER_UI(Learner_GetLanguage(), AbilityPlusDesc);
    case ABILITY_MINUS: return LEARNER_UI(Learner_GetLanguage(), AbilityMinusDesc);
    case ABILITY_FORECAST: return LEARNER_UI(Learner_GetLanguage(), AbilityForecastDesc);
    case ABILITY_STICKY_HOLD: return LEARNER_UI(Learner_GetLanguage(), AbilityStickyHoldDesc);
    case ABILITY_MARVEL_SCALE: return LEARNER_UI(Learner_GetLanguage(), AbilityMarvelScaleDesc);
    case ABILITY_LIQUID_OOZE: return LEARNER_UI(Learner_GetLanguage(), AbilityLiquidOozeDesc);
    case ABILITY_ROCK_HEAD: return LEARNER_UI(Learner_GetLanguage(), AbilityRockHeadDesc);
    case ABILITY_DROUGHT: return LEARNER_UI(Learner_GetLanguage(), AbilityDroughtDesc);
    case ABILITY_WHITE_SMOKE: return LEARNER_UI(Learner_GetLanguage(), AbilityWhiteSmokeDesc);
    case ABILITY_PURE_POWER: return LEARNER_UI(Learner_GetLanguage(), AbilityPurePowerDesc);
    case ABILITY_SHELL_ARMOR: return LEARNER_UI(Learner_GetLanguage(), AbilityShellArmorDesc);
    case ABILITY_CACOPHONY: return LEARNER_UI(Learner_GetLanguage(), AbilityCacophonyDesc);
    case ABILITY_AIR_LOCK: return LEARNER_UI(Learner_GetLanguage(), AbilityAirLockDesc);
